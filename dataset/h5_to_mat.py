...
problem_names = ["poisson", "advection", "graetz", "diffusion", "poiseuille", "elasticity", "stokes_u", "holed_advection", "lid_cavity_u_nl", "moving_hole_advection", "square_advection", "lid_driven_cavity"]
pb = 11 # 9 moving hole, 10 square, 11 lid-driven
n_comp = 2 if pb==11 else 1

# These lines define and open the path of the .h5 file
if pb == 9:
    h5_file = "moving_hole_advection/AdvectionDiffusion/" + problem_names[pb] + ".h5"
elif pb == 10:
    h5_file = "square_advection/Square_ADV/online_solution.h5"
elif pb == 11:
    h5_file = "lid_driven_cavity/lid_cavity_u_nl.h5"
else:
    print('Not tested using LD-GCA. Coming soon!')
...
mat_file = problem_names[pb]+"_unstructured.mat"
dataset = dict()
